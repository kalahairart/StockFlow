...
import { Announcement, AnnouncementType, AnnouncementTarget, AnnouncementRead } from '@/types/inventory';
...
export default function AdminAnnouncementsPage() {
  ...
  return (
    <div className="p-6 lg:p-10 space-y-8 max-w-7xl mx-auto min-h-screen">
      {/* Toast Notification */}
      <AnimatePresence>
        {toastMessage && (
          <motion.div

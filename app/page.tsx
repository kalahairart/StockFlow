    ...
    <div className="flex flex-col gap-10 relative">
      ...
      <section className="space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 px-2">
            <div>
                <h2 className="text-sm font-bold text-slate-500 uppercase tracking-[0.3em]">Operational Metrics</h2>
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              >
                ...
                <span className="xs:hidden">New SKU</span>
              </button>
              <button 
              ...
              >
                <Plus size={14} />
                <span className="hidden xs:inline">Stock Update</span>
      ...
      <section className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        <div className="xl:col-span-2 space-y-6">
            <div className="flex items-center justify-between px-2">
                <div>
                    <h2 className="text-sm font-bold text-slate-500 uppercase tracking-[0.3em]">Logistics Throughput</h2>
                    <div className="h-1 w-12 bg-indigo-500 rounded-full mt-2" />
                </div>
            </div>
        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between px-2">
                <div>
                    <h2 className="text-sm font-bold text-slate-500 uppercase tracking-[0.3em]">Withdrawal Log (30D)</h2>
                ...
                <button 
                  ...
                  title="Download CSV summary of all items withdrawn in the last 30 days"
                >
      ...
      <section className="flex flex-col gap-6">
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-4 px-2">
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-white tracking-tight">Real-time Inventory Mesh</h2>

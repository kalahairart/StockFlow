    ...
    <div className="flex flex-col gap-8 max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <ConfigCard 
            ...
            description="Manage authentication mesh and user authority levels."
            status="Secured"
        />
        <ConfigCard 
            icon={Database} 
            title="Storage Engine" 
            description="Database synchronization and latency synchronization."
            status="Optimal"
        />
        <ConfigCard 
            icon={HardDrive} 
            title="Resource Limits" 
            description="Configure SKU thresholds and warehouse capacity alerts."
            status="Active"
        />
        <ConfigCard 
            icon={Bell} 
            title="Notification Hub" 
            description="Low stock alerts and critical transaction pings."
            status="Enabled"
        />
      </div>
      ...
      <div className="bg-[#111114]/50 border border-white/5 rounded-3xl p-8 space-y-6">
        <div className="flex items-center justify-between">
            <div>
                ...
                <p className="text-sm text-slate-500">System health and telemetry export options.</p>
            </div>
